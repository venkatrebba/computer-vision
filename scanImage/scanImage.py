...
fileName = "/home/venkat/git/scanImage/IMG_20180419_174148.jpg"
...
# Converting as binary image
T = threshold_otsu(warped)
warped = (warped > T).astype("uint8") * 255

#cv2.imshow("image", image)
#cv2.imshow("edge", edged)
#cv2.imshow("warp", resize(warp, height = 300))
cv2.imwrite("scan_image.jpg",warped)
